...
class detrazioni_per_conigue_a_carico(Variable):
    ...
    reddito_per_detrazioni = person('reddito_totale_lordo_annuale',period) - person('deduzione_abitazione_principale',period) + person('importo_del_rendimento_nozionale_di_spettanza_dell_imprenditore',period)