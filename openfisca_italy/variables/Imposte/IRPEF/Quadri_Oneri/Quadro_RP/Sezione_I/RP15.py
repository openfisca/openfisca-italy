...
class RP15_si_possono_rateizzare_importo_spese_relative_a_righi_RP1_RP2_RP3(Variable):
    ...
    def formula(person,period,parameters):
        ...
        return where (spese_RP1_RP2_RP3> parameters(period).imposte.IRPEF.QuadroRP.sezione_I_Oneri_spese.imp_min_per_rateatiz_RP1_RP2_RP2, np.array(True), np.array(False))
...
class RP15_casella_2_importo_rata_o_somma_RP1_RP2_RP3(Variable):
        ...
        def formula(person,period,parameters):
            ...
            spese_senza_franchigia_casella_1_non_barrata = person('RP1_spese_sanitarie_comprensive_di_franchigia_rigo_RP1',period) + person('RP2_spese_sanitarie_per_familiari_non_a_carico_affetti_da_patologie_esistenti',period) - parameters(period).imposte.IRPEF.QuadroRP.sezione_I_Oneri_spese.franch_spese_med
            ...
            spese_senza_franchigia_casella_1_barrata = person('RP1_totale_spese_sanitarie',period) + person('RP2_spese_sanitarie_per_familiari_non_a_carico_affetti_da_patologie_esistenti',period) - parameters(period).imposte.IRPEF.QuadroRP.sezione_I_Oneri_spese.franch_spese_med
...
class RP15_altre_spese_al_19_colonna_3(Variable):
        ...
        def formula(person,period,parameters):
            ...
            totale_altre_spese_al_19_colonna_3_rigo_RP15 = where(codice_29_trovato_nelle_altre_spese_da_RP8_a_RP13,totale_altre_spese_al_19_colonna_3_rigo_RP15-parameters(period).imposte.IRPEF.QuadroRP.sezione_I_Oneri_spese.franch_spese_med,totale_altre_spese_al_19_colonna_3_rigo_RP15)
