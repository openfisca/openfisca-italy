...
class RP63_anno_sostenimento_spese_risparmio_energetico(Variable):
    value_type = int
    entity = Persona
    definition_period = YEAR
    entity = Persona
    label = "RP63 Col.2 - Indicare il anno sostenimento spesa intervento finalizzaot al risparmio energetico"
    reference = "http://www.agenziaentrate.gov.it/wps/file/Nsilib/Nsi/Schede/Dichiarazioni/Redditi+Persone+fisiche+2018/Modello+e+istruzioni+Redditi+PF2018/Istruzioni+Redditi+Pf+-+Fascicolo+1+2018/PF1_istruzioni_2018_Ret.pdf#page=78"  # Always use the most official source
...
class RP63_limite_spesa_in_base_a_codice_da_1_a_4(Variable):
    value_type = float
    entity = Persona
    definition_period = YEAR
    label= "Limite di spesa inseribile nel rigo RP63"
    reference = "http://www.agenziaentrate.gov.it/wps/file/Nsilib/Nsi/Schede/Dichiarazioni/Redditi+Persone+fisiche+2018/Modello+e+istruzioni+Redditi+PF2018/Istruzioni+Redditi+Pf+-+Fascicolo+1+2018/PF1_istruzioni_2018_Ret.pdf#page=78"  # Always use the most official source
    def formula(person,period,parameters):
        codice_tipo_intervento = person('RP63_tipo_intervento',period)
...
class RP63_limite_spesa_in_base_a_codice_5_6(Variable):
    value_type = float
    entity = Persona
    definition_period = YEAR
    label= "Limite di spesa inseribile nel rigo RP63"
...
class RP63_spesa_totale(Variable):
    value_type = float
    entity = Persona
    definition_period = YEAR
    label = "RP63 Col.8 - indicare l’ammontare della spesa sostenuta entro i limiti sottodescritti in relazione alla tipologia dell’intervento che, ad eccezione delle spese indicate con il codice 7 "
    reference = "http://www.agenziaentrate.gov.it/wps/file/Nsilib/Nsi/Schede/Dichiarazioni/Redditi+Persone+fisiche+2018/Modello+e+istruzioni+Redditi+PF2018/Istruzioni+Redditi+Pf+-+Fascicolo+1+2018/PF1_istruzioni_2018_Ret.pdf#page=78"  # Always use the most official source
...
class RP63_importo_rata(Variable):
    value_type = float
    entity = Persona
    definition_period = YEAR
