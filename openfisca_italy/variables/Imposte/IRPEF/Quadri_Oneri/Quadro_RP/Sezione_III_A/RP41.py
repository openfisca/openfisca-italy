...
class RP41TipiSpesaSostenutaPerRecuperoPatrimonioEdilizioInterventiAntisismici(Enum):
...
class RP41TipiInterventiParticolariPerRecuperoPatrimonioEdilizioInterventiAntisismici(Enum):
...
class RP41TipiCodiceEreditarietaInterventiDonazioniPerRecuperoPatrimonioEdilizioInterventiAntisismici(Enum):
...
class RP41NumeriRateInterventiDonazioniPerRecuperoPatrimonioEdilizioInterventiAntisismici(Enum):
...
class RP41_codice_2012_2013_2017_antisismico(Variable):
    value_type = Enum
    possible_values = RP41TipiSpesaSostenutaPerRecuperoPatrimonioEdilizioInterventiAntisismici
    default_value = RP41TipiSpesaSostenutaPerRecuperoPatrimonioEdilizioInterventiAntisismici.nessun_codice
    entity = Persona
...
class RP41_codice_fiscale(Variable):
    ...
    entity = Persona
    definition_period = YEAR
    label = u"RP41 Col.3 - Indicare il codice fiscale relativo a spese per interventi di recupero del patrimonio edilizio e misure antisismiche nel caso di lavori a condomini."


class RP41_interventi_particolari(Variable):
    value_type = Enum
    possible_values = RP41TipiInterventiParticolariPerRecuperoPatrimonioEdilizioInterventiAntisismici
    default_value = RP41TipiInterventiParticolariPerRecuperoPatrimonioEdilizioInterventiAntisismici.nessun_codice
    entity = Persona
    definition_period = YEAR
...
class RP41_acquisto_ereditarieta_donazione(Variable):
    value_type = Enum
    possible_values = RP41TipiCodiceEreditarietaInterventiDonazioniPerRecuperoPatrimonioEdilizioInterventiAntisismici
    default_value = RP41TipiCodiceEreditarietaInterventiDonazioniPerRecuperoPatrimonioEdilizioInterventiAntisismici.nessun_codice
    entity = Persona
    definition_period = YEAR
...
class RP41_Anno_rata(Variable):
    value_type = Enum
    possible_values = RP41NumeriRateInterventiDonazioniPerRecuperoPatrimonioEdilizioInterventiAntisismici
    default_value = RP41NumeriRateInterventiDonazioniPerRecuperoPatrimonioEdilizioInterventiAntisismici.nessun_codice
    entity = Persona
    definition_period = YEAR
