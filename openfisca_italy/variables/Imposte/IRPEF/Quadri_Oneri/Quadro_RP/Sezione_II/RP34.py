...
class codice_fiscale_societa_startup_in_cui_si_e_investito_Rigo_RP34(Variable):
    value_type = str
    entity = Persona
...
class quota_di_conferimento_in_start_up_eccedente_il_reddito_complessivo_Rigo_RP34(Variable):
    value_type = float
    entity = Persona
...
class totale_importo_RPF_2018_Rigo_RP34(Variable):
    value_type = float
    entity = Persona
...
class importo_residuo_RPF_2017_Rigo_RP34(Variable):
    value_type = float
    entity = Persona
...
class importo_residuo_RPF_2016_Rigo_RP34(Variable):
    value_type = float
    entity = Persona
...
class importo_residuo_RPF_2015_Rigo_RP34(Variable):
    value_type = float
    entity = Persona
