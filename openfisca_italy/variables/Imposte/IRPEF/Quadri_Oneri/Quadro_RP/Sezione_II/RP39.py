...
class RP_39_totale_oneri_deducibili(Variable):
    ...
    def formula(person,period,parameters):
        elementi_da_sommare = ['RP21_contributi_previdenziali_assistenziali','RP22_assegno_periodico_al_coniuge','RP23_contributi_addetti_servizi_domestici_e_familiari',
                                ...
                                'RP27_contributi_deducibilita_ordinaria_non_dedotti_dal_sostituto','contributi_per_lavoratori_prima_occupazione_non_dedotti_dal_sostituto','contributi_per_fondi_in_squilibrio_finanziario_non_dedotti_dal_sostituto',
