...
class RP57_col3_importo_rata_spesa_arredo_immobili_ristrutturati(Variable):
    ...
    def formula(person,period,parameters):
        vero_valore_RP57_col_2 = where(person('RP57_col2_spesa_arredo_immobili_ristrutturati',period)<parameters(period).imposte.IRPEF.QuadroRP.Sezione_III_C.RP57_limite_spesa_sostenuta, person('RP57_col2_spesa_arredo_immobili_ristrutturati',period) ,parameters(period).imposte.IRPEF.QuadroRP.Sezione_III_C.RP57_limite_spesa_sostenuta)
...
class RP57_col6_importo_rata_spesa_arredo_immobili_ristrutturati(Variable):
    ...
    def formula(person,period,parameters):
        vero_valore_RP57_col_5 = where(person('RP57_col5_spesa_arredo_immobili_ristrutturati',period)<parameters(period).imposte.IRPEF.QuadroRP.Sezione_III_C.RP57_limite_spesa_sostenuta, person('RP57_col5_spesa_arredo_immobili_ristrutturati',period) ,parameters(period).imposte.IRPEF.QuadroRP.Sezione_III_C.RP57_limite_spesa_sostenuta)
