...
class irpef_lorda (Variable):
    ...
    def formula(person, period, parameters):
        ...
        return select([irpef_non_dovuta_pensionati_e_terreni, irpef_non_dovuta_per_soli_terreni_e_fabbricati, reddito_imponibile <= 0 ,no_condizioni_redditi_non_tassabili], [0, 0, 0, irpef_lorda])
