...
class RN26_irpef_netta (Variable):
    ...
    def formula(person, period, parameters):
        RN4_reddito_imponibile = person('RN4_reddito_imponibile',period) # prendo il reddito imponibile perchè se questo era 0 o minore di 0 l'irpef netta è 0
        ...
        RN26_irpef_netta = where(RN4_reddito_imponibile <= 0, 0, RN26_irpef_netta) # se reddito imponibile è uguale a 0 anche l'imposta netta è 0
