...
class RN19_residuo_detrazione_startup_2015(Variable):
    value_type = float
    entity = Persona
    definition_period = YEAR
...
class RN19_detrazione_utilizzata_relativa_a_residuo_detrazione_startup_2015(Variable):
    value_type = float
    entity = Persona
    definition_period = YEAR
    ...
    def formula(person,period,parameters):
        ...
        return select([capienza<=0,
                        ...
                        where(capienza<=person('RN19_residuo_detrazione_startup_2015',period),capienza,person('RN19_residuo_detrazione_startup_2015',period))])
