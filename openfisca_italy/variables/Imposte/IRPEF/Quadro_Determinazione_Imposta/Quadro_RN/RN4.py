...
class RN4_reddito_imponibile (Variable):
    ...
    def formula(person, period, parameters):
        ...
        RN4_reddito_imponibile = person('RN1_reddito_complessivo',period) + person('RN1_credito_per_fondi_comuni',period) - person('RN1_perdite_compensabili_con_crediti_per_fondi_comuni',period) - person('RN2_deduzione_abitazione_principale',period) - person('RN3_oneri_deducibili_totali',period)
        ...
        RN4_reddito_imponibile = where (possiede_diritto_agevolazione_ACE,(RN4_reddito_imponibile + RS37_importo_del_rendimento_nozionale_di_spettanza_dell_imprenditore),RN4_reddito_imponibile)
        ...
        RN4_reddito_imponibile = where (possiede_diritto_agevolazione_per_attivita_sportive,(RN4_reddito_imponibile + RL22_compensi_con_ritenuta_a_titolo_di_imposta),RN4_reddito_imponibile)
        return where (RN4_reddito_imponibile >= 0, RN4_reddito_imponibile, np.array(0))
